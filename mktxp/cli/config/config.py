...
class CollectorKeys:
    ...
    WIFI_NEIGHBOR_COLLECTOR = 'WifiNeighborCollector'
...
class MKTXPConfigKeys:
    ...
    FE_WIFI_NEIGHBOR_KEY = 'wifi_neighbor'
    FE_WIFI_NEIGHBOR_DURATION_KEY = 'wifi_neighbor_scan_duration'
    FE_WIFI_NEIGHBOR_ALLOWLIST_KEY = 'wifi_neighbor_allowlist'
    ...
    DEFAULT_FE_WIFI_NEIGHBOR_ALLOWLIST_KEY = 'None'
    DEFAULT_FE_WIFI_NEIGHBOR_DURATION_KEY = '7'
    ...
    STR_KEYS = (HOST_KEY, USER_KEY, PASSWD_KEY, CREDENTIALS_FILE_KEY, SSL_CA_FILE, FE_REMOTE_DHCP_ENTRY, FE_REMOTE_CAPSMAN_ENTRY, FE_ADDRESS_LIST_KEY, FE_IPV6_ADDRESS_LIST_KEY, FE_CUSTOM_LABELS_KEY, FE_INTERFACE_NAME_FORMAT, FE_WIFI_NEIGHBOR_ALLOWLIST_KEY, FE_WIFI_NEIGHBOR_DURATION_KEY)
...
class ConfigEntry:
    MKTXPConfigEntry = namedtuple('MKTXPConfigEntry', [MKTXPConfigKeys.ENABLED_KEY, MKTXPConfigKeys.HOST_KEY, MKTXPConfigKeys.PORT_KEY,
                                                       ...
                                                       MKTXPConfigKeys.FE_WIFI_NEIGHBOR_KEY, MKTXPConfigKeys.FE_WIFI_NEIGHBOR_DURATION_KEY, MKTXPConfigKeys.FE_WIFI_NEIGHBOR_ALLOWLIST_KEY
                                                       ])
...
class MKTXPConfigHandler:
    ...
    def _default_value_for_key(self, key, value=None):
        return {
            ...
            MKTXPConfigKeys.FE_WIFI_NEIGHBOR_ALLOWLIST_KEY: lambda _: MKTXPConfigKeys.DEFAULT_FE_WIFI_NEIGHBOR_ALLOWLIST_KEY,
            MKTXPConfigKeys.FE_WIFI_NEIGHBOR_DURATION_KEY: lambda _: MKTXPConfigKeys.DEFAULT_FE_WIFI_NEIGHBOR_DURATION_KEY,
